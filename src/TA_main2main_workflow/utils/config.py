...
class TAConfig:
    ...
    def from_env(cls) -> TAConfig:
        return cls(
            ...
            triton_ascend_url=os.getenv("TRITON_ASCEND_URL", "https://github.com/triton-lang/triton-ascend.git"),
            triton_path=os.getenv("TRITON_PATH", ""),
            triton_upstream_url=os.getenv("TRITON_UPSTREAM_URL", "https://github.com/triton-lang/triton.git"),
            target_commit=os.getenv("TRITON_TARGET_COMMIT", ""),
            ai_backend=_env_choice("AI_BACKEND", ["opencode", "claude", "auto"], "auto"),
            ...
            llvm_repo_url=os.getenv("LLVM_REPO_URL", "https://github.com/llvm/llvm-project.git"),
